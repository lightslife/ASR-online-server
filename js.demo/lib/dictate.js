(function(window){
	...
	// Defaults
	var SERVER = "ws://localhost:8888/worker/ws/speech";
	var SERVER_STATUS = "ws://localhost:8888/worker/ws/speech";
	var REFERENCE_HANDLER = "http://localhost:8888/worker/ws/speech";
